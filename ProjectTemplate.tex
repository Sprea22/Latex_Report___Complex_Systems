...
Una volta individuate le configurazioni migliori intra BT si è passati a confrontarle quelle con BT diversi. Le configurazioni considerate durante questa ultima fase sono state: \text{BT1\_A6}, \text{BT2\_A6}, \text{BT2\_A12}, \text{BT3\_A6} e \text{BT3\_A12}.\\
